...
const handler = (event,callback) => {
    debug && console.log("Super Admin Get All User By Region and Province Handler")
    const {regionID} = event.params;

    const query = `call SuperAdmin_GetAllUsersByRegionID(${regionID});`;
    try{
