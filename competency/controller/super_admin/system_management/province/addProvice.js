...
const json_exist = {"result":"SUCCESS","message":"Province already exist"};
...
const handler = (event, callback) => {
    debug && console.log("Super Admin Add Province Handler")

    const { provinceName, provinceDirector, username, regionID} = event.body

    const query = `call SuperAdmin_AddProvince(${regionID}, '${provinceName}', '${provinceDirector}', '${username}')`
    try {
