...
const handler = (event,callback) => {
    debug && console.log("Super Admin Get All By Region and Province User Handler")
    const {regionID, provID} = event.params;

    const query = `call SuperAdmin_GetAllUsersByRegionIDAndProvID(${regionID}, ${provID});`;
    try{
