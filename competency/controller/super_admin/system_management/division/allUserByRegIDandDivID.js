...
const handler = (event,callback) => {
    debug && console.log("Super Admin Get All User By Region and Division Handler")
    const {regionID, divID} = event.params;

    const query = `call SuperAdmin_GetAllUsersByRegionIDAndDivID(${regionID}, ${divID});`;
    try{
