...
const json_exist = {"result":"EXIST","message":"Division already exist"};
...
const handler = (event, callback) => {
    debug && console.log("Add Division Handler")

    const { divisionName, divisionChief, username, regionID} = event.body

    const query = `call SuperAdmin_AddDivision(${regionID}, '${divisionName}', '${divisionChief}', '${username}')`
    try {
