...
const handler = (event,callback) => {
    debug && console.log("Get All Cluster By Region and Province Handler")
    const { rid , provID } = event.params;

    const query = `call SuperAdmin_GetAllClusterByRegionAndProvince(${rid}, ${provID});`;
    try{
