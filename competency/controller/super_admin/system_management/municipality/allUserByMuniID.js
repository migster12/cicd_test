...
const handler = (event,callback) => {
    debug && console.log("Super Admin Get All User By Region and Municipality Handler")
    const {regionID, municipalityID} = event.params;

    const query = `call SuperAdmin_GetAllUsersByRegionIDAndMuniID(${regionID}, ${municipalityID});`;
    try{
